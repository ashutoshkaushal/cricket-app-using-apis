...
function currentMatch()
{
    var xmlhttp=new XMLHttpRequest();
      ...
      if(this.readyState==4 && this.status==200)
       {
        ...
        var id="<p style='opacity:0;'>"+"<b>Unique_Id: </b>"+obj.matches[i].unique_id +"</p>"
     ...
     xmlhttp.open("GET", "https://cricapi.com/api/cricketScore?apikey=anb2yn1mEhYfYmVpe3W6Cxxfb492&unique_id=1034809", true);
     xmlhttp.send();
 }
/* Current Match End */
...
function oldMatch()
{
    var xmlhttp=new XMLHttpRequest();
      ...
      if(this.readyState==4 && this.status==200)
       {
        ...
        var id="<p style='opacity:0;'>"+"<b>Unique_Id: </b>"+obj.data[i].unique_id +"</p>"
     ...
     xmlhttp.open("GET", "https://cricapi.com/api/cricket?apikey=anb2yn1mEhYfYmVpe3W6Cxxfb492", true);
     xmlhttp.send();
 }
/* Old Match End */
...
function matchCal()
{
    var xmlhttp=new XMLHttpRequest();
     ...
     xmlhttp.open("GET", "https://cricapi.com/api/matchCalendar?apikey=anb2yn1mEhYfYmVpe3W6Cxxfb492", true);
     xmlhttp.send();
 }
/* New Match End */
...
function enterTheCode()
{
   ...
   else
 {
    var xmlhttp=new XMLHttpRequest();
     ...
     xmlhttp.open("GET", "https://cricapi.com/api/playerFinder?apikey=anb2yn1mEhYfYmVpe3W6Cxxfb492&name="+str+"/", true);
     xmlhttp.send();
      ...
      if(this.readyState==4 && this.status==200)
       {
         document.getElementById("container").innerHTML=this.responseText;
        var obj=JSON.parse(this.responseText);
        var status="<p style='padding:5px;'>"+"<b>Status: </b>"+obj.stat+"</p>"
